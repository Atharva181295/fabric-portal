"""
Django setting for fabric_portal project.
...
SECRET_KEY = 'django-insecure-lit-z+8l_n%%51z-t4v($h-yq@otx84zj1$3r11rpt!zrz%3sn'
...
ROOT_URLCONF = 'fabric_portal.urls'
...
WSGI_APPLICATION = 'fabric_portal.wsgi.application'
